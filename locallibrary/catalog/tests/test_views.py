...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        # Create two users
        test_user1 = User.objects.create_user(username='testuser1', password='Pa$$word')
        test_user2 = User.objects.create_user(username='testuser2', password='Pa$$word')
    ...
    def test_logged_in_uses_correct_template(self):
        login = self.client.login(username='testuser1', password='Pa$$word')
        response = self.client.get(reverse('my-borrowed'))
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        login = self.client.login(username='testuser2', password='Pa$$word')
